...
class Gens:
    ...
    #- yields number * 2 to infinity, starting at self.start
    def doubles(self):
        i = self.start
        while True:
            yield i
    ...
    #- Yields the next number in the fibonacci sequence to infinity, starting at 1
    def fib(self):
        i = 1
        iNext = 0
        iTemp = 0
    ...
    def sequence(self, list):
        ...
        while True:
            yield list[i]
            i = (i+1)%len(list)#mod(i + 1, len(list)-1)
...
print("Test Sequence")
x = 1
for i in k.sequence([1, 2, 3]):
    if x > 10:
        break
    print(i)
    x+=1

print("Test Triple Half")
for i in g.triple_half():
    if i > 100:
        break
    print(i)
